# Archived campaign closeouts

Historical records of finished refactoring campaigns, kept for their decision
notes. They are not roadmaps. File paths inside them predate the ORG1 folder
moves, and some status claims (for example `consolidation.md`'s "CI cannot go
green / 90-minute timeout") are no longer true.
