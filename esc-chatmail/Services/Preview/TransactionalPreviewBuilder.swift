...
struct TransactionalPreviewBuilder {
    ...
    private func buildPreview(
        ...
        let appStoreExtractor = AppStoreNotificationPreviewExtractor(
            lineProcessor: lineProcessor,
            sanitizeTitle: self.sanitizedTransactionTitle,
            normalizeLine: self.normalizedCandidateLine
        )
        let appleDeveloperNotification = appStoreExtractor.notification(
            canonicalHTML: canonicalHTML,
            subject: subject,
            senderEmail: senderEmail,
            sourceDomain: sourceDomain,
