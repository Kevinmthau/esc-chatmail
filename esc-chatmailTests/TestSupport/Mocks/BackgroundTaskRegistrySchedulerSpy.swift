...
/// back hosted unit tests: the host app already registered every identifier
/// at launch, re-registering one is an Apple assertion failure that aborts
/// the process, and the simulator rejects submits outright.
