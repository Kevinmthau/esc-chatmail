...
final class EmailPreviewClassifierTests: XCTestCase {
    ...
    func testClassifyTestFlightAvailabilityEmail_withoutPreviewSignalDoesNotForceTransactional() {
        let html = """
        <!DOCTYPE html>
        <html>
        <body>
        ...
        XCTAssertFalse(result.signals.contains(.transactionalKeywords))
    }
